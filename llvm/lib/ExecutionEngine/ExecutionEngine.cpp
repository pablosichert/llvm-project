...
ExecutionEngine *(
    *ExecutionEngine::MCJITCtor)(std::unique_ptr<Module> M,
                                 std::string *ErrorStr,
...
ExecutionEngine *EngineBuilder::create(TargetMachine *TM) {
  std::cout << "EngineBuilder::create 1" << std::endl;
  std::unique_ptr<TargetMachine> TheTM(TM); // Take ownership.
  std::cout << "EngineBuilder::create 2" << std::endl;
  ...
  std::cout << "EngineBuilder::create 3" << std::endl;
  ...
  std::cout << "EngineBuilder::create 4" << std::endl;
  ...
  if ((WhichEngine & EngineKind::JIT) && TheTM) {
    ...
    std::cout << "EngineBuilder::create 5" << std::endl;

    ExecutionEngine *EE = nullptr;
    if (ExecutionEngine::MCJITCtor) {
      std::cout << "EngineBuilder::create 5 MCJITCtor" << std::endl;
      EE = ExecutionEngine::MCJITCtor(std::move(M), ErrorStr, std::move(MemMgr),
                                      std::move(Resolver), std::move(TheTM));
    }

    std::cout << "EngineBuilder::create 5.0" << std::endl;

    if (EE) {
      std::cout << "EngineBuilder::create 5.1" << std::endl;
      EE->setVerifyModules(VerifyModules);
      std::cout << "EngineBuilder::create 5.2" << std::endl;
      return EE;
    }
  }

  std::cout << "EngineBuilder::create 6" << std::endl;
  ...
  std::cout << "EngineBuilder::create 7" << std::endl;
  ...
  std::cout << "EngineBuilder::create 8" << std::endl;
